...
kOmegaSSTCCLMSato<BasicMomentumTransportModel>::kOmegaSSTCCLMSato
(
...
template<class BasicMomentumTransportModel>
bool kOmegaSSTCCLMSato<BasicMomentumTransportModel>::read()
{
    if (kOmegaSSTLM<BasicMomentumTransportModel>::read())
    {
...
kOmegaSSTCCLMSato<BasicMomentumTransportModel>::getDispersedPhases() const
{
...
template<class BasicMomentumTransportModel>
void kOmegaSSTCCLMSato<BasicMomentumTransportModel>::correctNut
(
...
template<class BasicMomentumTransportModel>
void kOmegaSSTCCLMSato<BasicMomentumTransportModel>::correct()
{
    kOmegaSSTLM<BasicMomentumTransportModel>::correct();
}
